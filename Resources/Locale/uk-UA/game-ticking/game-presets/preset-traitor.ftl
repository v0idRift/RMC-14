...
traitor-role-uplink-implant = Ваш імплант аплінка активовано, отримайте до нього доступ з панелі швидкого доступу.
    Аплінк захищений, якщо хтось не видалить його з вашого тіла.

# не потрібен весь текст для меню персонажа
traitor-role-uplink-implant-short = Ваш аплінк було імплантовано. Доступ до нього з панелі швидкого доступу.
