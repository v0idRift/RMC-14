...
command-description-prototypecontains = Фільтрує сутності за тим, чи містить їхній ідентифікатор прототипу заданий текст.
command-description-icon-get_human_readable = Отримує читабельну для людини назву іконки роботи гравця.
command-description-icon-get = Отримує назву іконки роботи гравця.
command-description-icon-set = Встановлює іконку роботи гравця.
command-description-icon-del = Видаляє піктограму роботи гравця.
...
command-description-hive-set = Встановлює вулик ксеноморфа або групи ксеноморфів.
command-description-requisitions-addbudget = Додає бюджет до стандартного рахунку Реквізицій.
command-description-requisitions-removebudget = Видаляє бюджет зі стандартного рахунку Реквізицій.
command-description-intel-addpoints = Додає бали до стандартного дерева технологій Розвідки.
command-description-intel-removepoints = Видаляє бали зі стандартного дерева технологій Розвідки.
command-description-weedkiller = Запускає гербіцид у поточному районі. Це вбиває всі бур'яни та смоляні структури поблизу.