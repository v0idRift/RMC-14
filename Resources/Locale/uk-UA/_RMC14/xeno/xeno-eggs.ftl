...
cm-xeno-egg-failed-must-hive-weeds = Яйце має бути посаджене на бур'яни вулика.
rmc-xeno-egg-ghost-need-time-round = Ви не можете стати паразитом, доки не пройде достатньо часу в раунді (залишилося {$seconds} секунд).