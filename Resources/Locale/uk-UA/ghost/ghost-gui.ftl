...
ghost-roles-window-raffle-in-progress-button = Приєднатися (залишилося {$time}, { $players ->
         [one] {$players} гравець
        *[other] {$players} гравців
    })
ghost-roles-window-leave-raffle-button = Залишити (залишилося {$time}, { $players ->
         [one] {$players} гравець
        *[other] {$players} гравців
    })
