...
reagent-effect-condition-guidebook-mob-state-condition = сутність { $state }

reagent-effect-condition-guidebook-job-condition = робота цілі є { $job }

reagent-effect-condition-guidebook-solution-temperature = температура рідини { $max ->
...
reagent-effect-condition-guidebook-organ-type = метаболізуючий орган { $shouldhave ->
                                [true] є
                                *[false] не є
