...
power-monitoring-window-unknown-location = Невідоме місцезнаходження місцезнаходження
...
power-monitoring-window-total-loads = Загальне навантаження на мережу на мережу
