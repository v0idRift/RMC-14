...
generic-misconfigured = Сервер налаштовано неправильно, і він не приймає гравців. Будь ласка, зв'яжіться з власником сервера і спробуйте пізніше.
ipintel-server-ratelimited = Цей сервер використовує систему безпеки із зовнішньою перевіркою, яка досягла максимального ліміту перевірки. Будь ласка, зв'яжіться з адміністрацією сервера для отримання допомоги та спробуйте пізніше.
ipintel-unknown = Цей сервер використовує систему безпеки із зовнішньою перевіркою, але сталася помилка. Будь ласка, зв'яжіться з адміністрацією сервера для отримання допомоги та спробуйте пізніше.
ipintel-suspicious = Схоже, ви підключаєтеся через центр обробки даних або VPN. З адміністративних причин ми не дозволяємо підключення через VPN для гри. Будь ласка, зв'яжіться з адміністрацією сервера для отримання допомоги, якщо ви вважаєте, що це помилка.